        ...
        return (
          <div style={{ marginTop: 70 }}>
            <Row sm="12" className="img-top">
              <img className="img" src={require('../assets/image/socmed.jpg')} alt='loading'/>
            </Row>
            <Row>
              <Col sm="6" className="one-row">
                <img className="img" src={require('../assets/image/spashbrand1.jpeg')} alt='loading'/>
              </Col>
            ...
            <Row>
              <Col sm="6" className="one-row">
                <Col sm={{ size: 7, offset: 3 }}  className="index-head">
                  <div className="index-two" style={{ lineHeight: 1 }}>
                    Complete & Real-Time
                  </div>
                  <div className="index-two">
                    Coverage
              ...
              <Col sm="6" className="two-row">
                <img className="img" src={require('../assets/image/spashfb.jpeg')} alt='loading'/>
              </Col>
            </Row>
            <Row>
              <Col sm="6" className="one-row">
                <img className="img" src={require('../assets/image/spashtwitter.jpeg')} alt='loading'/>
              </Col>
              <Col sm="6" className="two-row">
                <Col sm={{ size: 7, offset: 2 }}  className="index-head">
                  <div className="index-two">
            ...
            <Row>
              ...
              <Col sm="6" className="two-row margin-bottom-10">
                <img className="img" src={require('../assets/image/spashnews.jpeg')} alt='loading'/>
              </Col>
            </Row>
          </div>
        );
